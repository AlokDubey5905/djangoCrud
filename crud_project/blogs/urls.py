...
urlpatterns = [
    ...
    path('api/add_blog/', login_required(views.add_blog_api), name='add-blog'),
    path('api/edit_blog/<int:blog_id>/', login_required(views.edit_blog_api), name='edit-blog'),
    path('api/delete_blog/<int:blog_id>/', login_required(views.delete_blog_api), name='delete-blog'),
