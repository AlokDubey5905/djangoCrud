...
urlpatterns = [
    ...
    path('api/user_blogs/', login_required(views.user_blogs_api),
         name='user_blogs_api'),
    ...
    path('api/edit_blog/<int:blog_id>/',
         login_required(views.edit_blog_api), name='edit_blog_api'),
    path('api/delete_blog/<int:blog_id>/',
         login_required(views.delete_blog_api), name='delete_blog_api'),
    path('api/search/', views.search_blogs, name='search_blogs_api'),
    path('api/public-blogs/<int:blog_id>/comments/',
         views.PublicCommentListView.as_view(), name='public-comment-list'),
    path('api/blogs/<int:blog_id>/comments/',
         views.CommentListCreateView.as_view(), name='comment-list-create'),
    path('api/blogs/<int:blog_id>/comments/<int:pk>/',
         views.CommentDetailView.as_view(), name='comment-detail'),
    path('api/comments/<int:pk>/', views.CommentUpdateDeleteView.as_view(),
